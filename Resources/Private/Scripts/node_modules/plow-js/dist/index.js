(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.plow = {}));
      ...
      return function (value) {
        return function (subject) {
          ...
          if (Array.isArray(target)) {
            return $set$2(path, [].concat(_toConsumableArray(target), [value]), subject);
          }
          ...
          return $set$2([].concat(_toConsumableArray(resolveObjectPath(path)), [key]), value[key], subject);
        };
      };
    });
    ...
    var index$5 = createPolymorphFunction(function (path) {
      return function (value) {
        return function (subject) {
          ...
          if (Array.isArray(target)) {
            return $set$2(path, [value].concat(_toConsumableArray(target)), subject);
          }
    ...
    var merge = function merge(path, value, subject) {
      return Object.keys(value).reduce(function (subject, key) {
        if (_typeof(value[key]) === 'object') {
          return merge([].concat(_toConsumableArray(path), [key]), value[key], subject);
        }
